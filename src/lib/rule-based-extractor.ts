// import { ExtractedEntity, ExtractedRelationship } from './llm-service'; // Not needed for MCP standalone
// import { ToolCall } from '../types/chat'; // Not needed for MCP standalone
import { ConsciousMemory, ConsciousMemoryMetadata } from '../types/memory.js'; // For ConsciousMemory types

// Define types locally since we don't have llm-service
...
// ToolCall type for tool invocations
